...
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/am_map.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/ct_chat.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/d_main.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/d_net.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_ammo.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_frame.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_htic.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_htext.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_sound.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_thing.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/deh_weapon.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/f_finale.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/g_game.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/in_lude.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/info.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/m_random.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/mn_menu.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_ceilng.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_doors.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_enemy.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_floor.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_inter.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_lights.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_map.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_maputl.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_mobj.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_plats.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_pspr.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_saveg.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_setup.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_sight.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_spec.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_switch.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_telept.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_tick.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/p_user.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_bsp.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_data.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_draw.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_main.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_plane.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_segs.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/r_things.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/s_sound.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/sb_bar.c
@set GLOBOBJS=%GLOBOBJS% ../src/heretic/sounds.c

gcc %GLOBOBJS% %CFLAGS% -I. -I../opl -I../pcsound -I../src -I../textscreen -DHAVE_DIRENT_H -DGAME=\"Heretic\" -lemu -o CHERETIC/CHERETIC.EXE
strip -s CHERETIC/CHERETIC.EXE
stubedit CHERETIC/CHERETIC.EXE dpmi=CWSDPR0.EXE
